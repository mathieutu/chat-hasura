<template>
  ...
  >
    <div class="flex items-center justify-between w-full p-3">
      ...
      <div class="ml-4 mr-auto text-lg font-medium">
        Info
      </div>
      <button
        type="button"
    ...
    <div class="flex items-center w-full px-3 mt-6">
      ...
      <div class="ml-4">
        ...
        <div class="mt-1 mr-auto text-sm font-semibold leading-none text-gray-600">
          Bio
        </div>
      </div>
    </div>
    <div>
      <div class="flex items-center w-full px-3 mt-4">
        ...
        <div>
          <div class="ml-4 mr-auto text-sm font-semibold text-gray-800">
            @karen
          </div>
          <div class="mt-1 ml-4 mr-auto text-sm font-semibold leading-none text-gray-600">
            Username
          </div>
        </div>
      </div>
