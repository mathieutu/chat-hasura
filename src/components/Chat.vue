<template>
  <div class="relative flex flex-col flex-1">
    <div class="z-20 flex flex-grow-0 flex-shrink-0 w-full pr-3 bg-white border-b">
      ...
      <button
        type="button"
        class="flex self-center hidden p-2 ml-2 text-gray-500 rounded-full lg:block focus:outline-none hover:text-gray-600 hover:bg-gray-300"
      >
        <svg
          class="w-6 h-6 text-gray-600 fill-current"
          xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="top-0 bottom-0 left-0 right-0 flex flex-col flex-1 overflow-hidden bg-transparent bg-bottom bg-cover">
      ...
      >
        <div class="w-full">
          ...
          <input
            type="search"
            class="w-full py-2 pl-10 text-sm placeholder-gray-800 bg-white border border-transparent appearance-none rounded-tg focus:bg-white focus:outline-none focus:border-blue-500 focus:text-gray-900 focus:shadow-outline-blue"
